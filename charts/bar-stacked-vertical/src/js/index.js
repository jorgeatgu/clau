const barStackedVertical = () => {
    ...
    const scales = {};
    let dataz;
    const colors = d3.scaleOrdinal().range(['#2A7D97', '#DB455E']);
    ...
    const updateChart = (dataz) => {
        ...
        const otherLayer = layer.selectAll('.bar-vertical').data(function(d) {
            return d;
        });

        const newLayer = otherLayer
            .enter()
            .append('rect')
